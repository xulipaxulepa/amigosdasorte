        ...
        <table class="table table-striped">
            ...
            foreach ($bolao->result() as $boloes) {
                if ($boloes->jogo == 'Mega Sena'):
                    ...
                    } else if ($this->session->email != '' || $this->session->email != null){
                            echo '<a href="' . base_url('bolao/comprar/' . $boloes->id) . '" class="btn btn-success btn-xs" role="button"> Comprar </a>';

                            echo '</td>';
                    } else{
                            echo '<a href="' . base_url('usuario/cadastrar') . '" class="btn btn-success btn-xs" role="button"> Comprar </a>';
